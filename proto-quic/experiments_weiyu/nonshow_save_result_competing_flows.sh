...
mv qlen*.txt $dirname
mv /home/maki/ephemeral-quic/delay_client_server.txt $dirname
mv /home/maki/ephemeral-quic/delay_server_client.txt $dirname
mv /home/maki/ephemeral-quic/Old_Messages.txt $dirname
...
cp /home/maki/ephemeral-quic/proto-quic/src/net/tools/quic/quic_spdy_client_base.cc $dirname/
cp /home/maki/ephemeral-quic/proto-quic/src/net/tools/quic/quic_simple_client_bin.cc $dirname/
