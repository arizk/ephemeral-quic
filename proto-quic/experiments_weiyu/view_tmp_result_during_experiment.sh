...
cp qlen*.txt $dirname
cp /home/maki/ephemeral-quic/delay_client_server.txt $dirname
cp /home/maki/ephemeral-quic/delay_server_client.txt $dirname
cp /home/maki/ephemeral-quic/Old_Messages.txt $dirname
